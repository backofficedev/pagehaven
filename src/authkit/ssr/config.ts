...
export function configure(config: Parameters<typeof configuration.configure>[0]) {
  configuration.configure(config)
}

export function getConfig<T>(key: Parameters<typeof configuration.getValue>[0], defaultValue?: T): T | undefined {
